        ...
        <div class="table-responsive">
            <table id="ventaDia" class="table table-dark table-condensed responsive" width="99%" style="color:white;">
                <thead>
                    <th>Nº Fact.</th>
                    <th>Fecha</th>
                    <th>Cliente</th>
                ...
                <?php
                    ...
                    $sql="SELECT fac_id, fac_fecha_hora, fac_nombre_cliente, fac_nombre_usuario, fac_total, fac_utilidad FROM factura WHERE fac_estado = 1 AND DATE(fac_fecha_hora) = '$fecha'";
                 ...
                 ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<span style='color:; font-weight:bold'>"."Bs. "."</span>".$registro[4]; ?>
                        </td>
