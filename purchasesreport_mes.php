        ...
        <div class="table-responsive">
            <table id="compraMes" class="table table-dark table-condensed responsive" width="99%" style="color:white;">
                ...
                <?php
                    ...
                    $sql="SELECT fac_id, fac_fecha_hora, fac_nombre_cliente, fac_nombre_usuario, fac_total, fac_utilidad FROM factura WHERE month(fac_fecha_hora) = '$mes' and year(fac_fecha_hora) = '$year'";
