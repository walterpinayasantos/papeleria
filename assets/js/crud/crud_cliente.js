function CrearCliente(valor1,valor2,valor3,valor4){
	
	cadena="nombre=" + valor1 + "&ci_nit=" + valor2 + "&celular=" + valor3 + "&direccion=" + valor4;
	...
	$.ajax({
		...
		success:function(r){
			if(r==1){														//Si la insercion de datos es exitosa.
        		//$('#tabla_cliente').load('cliente_tabla.php');			//Recargar el DataTaable con AJAX
        		$('#modal_crear_cliente').on('hidden.bs.modal',function(){//Limpia los inputs del formulario, que estan en el modal
        			$(this).find('#form_nuevo_cliente')[0].reset();
        		});
