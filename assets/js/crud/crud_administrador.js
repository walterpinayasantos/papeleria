function CrearAdministrador(valor1,valor2,valor3,valor4,valor5){
	
	cadena="nombres=" + valor1 + "&apellidos=" + valor2 + "&ci=" + valor3 + "&celular=" + valor4 + "&direccion=" + valor5;
	...
	$.ajax({
		...
		success:function(r){
			if(r==1){															//Si la insercion de datos es exitosa.
        		...
        		$('#modal_crear_administrador').on('hidden.bs.modal',function(){//Limpia los inputs del formulario, que estan en el modal
